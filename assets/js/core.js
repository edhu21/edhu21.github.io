                ...
                if ($contactForm.valid()){
                    $.ajax({
                        ...
                        success: function(msg) {
                            if (msg === 'SEND') {
                                response = '<div class="alert alert-success">Done! Thank for your message - You will get you an answer as fast as possible!'; /*¡Mensaje enviado! Gracias por su mensaje. ¡Recibirá una respuesta lo más rápido posible!*/
                            }
                            else {
                ...
                $bar.each(function(){ 
                    setTimeout(function() {
                        ...
                        setInterval(function() {
                            i++;
                            if(i<=value) {
                                $bar.children('span').text(i+'%'); /*.text(i+'%') fue eliminado de core.min.js para que no aparezca la cantidad y %*/
                            };
                        }, 15);
                        $bar.css('width',value+'%');
                    },300)
